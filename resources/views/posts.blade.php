    ...
    <div class="row justify-content-center mb-3">
        <div class="col-md-6">
            <form action="/blog">
                ...
                @endif
                @if(request('editor'))
                    <input type="hidden" name="editor" value="{{ request('editor') }}">
                @endif
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                ...
                <h5><small class="text-muted">Kategori Film: <a href="/blog?category={{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}</a></small></h5>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <h5 class="card-title"><a href="/blog/{{ $post->slug }}" class="text-decoration-none text-dark">{{ $post->title }}</a></h5><h6><small class="text-muted">Kategori Film: <a href="/blog?category={{ $post->category->slug }}" class="text-decoration-none">{{ $post->category->name }}</a></small></h6>
